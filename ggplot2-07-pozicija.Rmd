...
panašūs: išvesti iš geom_point. jitter sklaidą turi: skiriasi savo pozicija, skiriasi statistinė transformacija. count suskaičiuoja kiek yr taškų ir nubrėžia vieną didelį tašką.
...
```{r}
ggplot(mpg) + 
    geom_boxplot(mapping = aes(group = 1, x = cty, y = hwy)) 
